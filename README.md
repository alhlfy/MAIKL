...
**use::**  ``` git clone https://github.com/alhlfy/MAIKL.git && cd MAIKL && chmod +x install.sh && ./install.sh ```
______________________________________________________________________________________________________________________
...
**use::**  ``` git clone https://github.com/alhlfy/MAIKL.git && cd MAIKL && chmod +x Fastinstall.sh &&chmod +x install.sh && ./Fastinstall.sh```
